...
const FeaturesEvents = () => {
  ...
  <div className=" text-white h-full m-5 md:flex md:flex-row-reverse ">
    <img className="w-80 h-60 mb-5 md:absolute md:mt-14 sm:right-4 lg:right-36 lg:w-1/4 lg:h-60 " src={process.env.PUBLIC_URL + "../../../images/Rectangle 67.png"} alt=""/>
   <div>
    <h1 className=" text-2xl sm:text-3xl lg:text-4xl sm:absolute sm:left-14 lg:left-32 md:mt-10 mb-5 font-semibold ">Dinner party of Luis Family </h1>
    ...
    <button className="bg-blue-400 md:absolute lg:left-32 sm:left-14 sm:mt-32 md:mt-34 w-80 h-16 mt-5 rounded-lg font-bold">Book TIcket</button>
  </div>
  </div>
  </div>
  );
