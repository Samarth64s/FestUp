  ...
  return (
    <footer className="bg-black text-white p-4 sm:p-8">
      ...
      <nav className="flex flex-wrap justify-center mb-4">
        <Link to="#" className="mr-2 sm:mr-4 mb-2 sm:mb-0 underline block">
          Home
        </Link>
        <Link
          to="/Events"
          className="mr-2 sm:mr-4 mb-2 sm:mb-0 underline block"
        >
          Events
        </Link>
        <Link to="#" className="mr-2 sm:mr-4 mb-2 sm:mb-0 underline block">
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between mb-4">
        <div className="mb-2">
          <Link to="#" className="mr-2 sm:mr-4 mb-2 sm:mb-0">
            Privacy Policy |
          </Link>
          <Link to="#" className="mr-2 sm:mr-4 mb-2 sm:mb-0">
            Refund Policy |
