...
import logo from "../assets/images/FestUp.png";
    ...
    <div>
      <div className="bg-black h-20 w-full text-white flex items-center justify-between">
        <div className="sm:flex sm:items-center flex ml-4 w-full">
          <div
            className="sm:hidden mt-2.5 flex-1"
            onClick={handleDropdownToggel}
          >
            <GiHamburgerMenu size={28} />
          </div>

          <img className="sm:ml-5 flex-1 sm:flex-none" src={logo} alt="Logo" />
          ...
          <img
            className="mr-4  cursor-pointer space-x-44"
            src={profileimg}
            alt=""
          />
        </div>
        ...
        <div className="bg-black w-56 h-40 absolute text-white z-10">
          <nav>
            <ul className="ml-4">
              ...
              <li>
                <Link to="/EventsPage" onClick={closeDropdown}>
                  Events
                </Link>
              </li>
              <li>
                <Link to="/ListYourEventPage" onClick={closeDropdown}>
                  List Your Event
                </Link>
              </li>
            </ul>
